        ...
        <div class="table-container section-spacing">
            <div class="table-header">
                <h3 class="table-title">
                    ...
                    Acuan Berat Badan Laki-laki
                </h3>
                <p class="table-subtitle">Standar WHO untuk anak laki-laki (kg)</p>
            </div>
                    ...
                    <thead class="table-head">
                        <tr>
                            ...
                            <th class="header-cell red">
                                -3 SD<br><span class="header-label">Sangat Kurus</span>
                            </th>
                            <th class="header-cell orange highlight">
                                -2 SD<br><span class="header-label">Kurus</span>
                            </th>
                            ...
                            <th class="header-cell orange">
                                +2 SD<br><span class="header-label">Gemuk</span>
                            </th>
                            <th class="header-cell red">
                                +3 SD<br><span class="header-label">Sangat Gemuk</span>
                            </th>
                        </tr>
                    </thead>
        ...
        <div class="table-container girls section-spacing">
            <div class="table-header girls">
                <h3 class="table-title girls">
                    ...
                    Acuan Berat Badan Perempuan
                </h3>
                <p class="table-subtitle girls">Standar WHO untuk anak perempuan (kg)</p>
            </div>
            <div class="table-wrapper">
                <table class="data-table">
        ...
        <div class="info-section">
                ...
                <div class="legend-column">
                    <div class="legend-item red">
                        ...
                        <div class="legend-content">
                            ...
                            <p class="legend-desc red">Sangat Kurus / Sangat Gemuk</p>
                        </div>
                    </div>
                    <div class="legend-item orange">
                        ...
                        <div class="legend-content">
                            ...
                            <p class="legend-desc orange"><strong>Kurus</strong> / Gemuk</p>
                        </div>
                    </div>
                </div>
                <div class="legend-column">
                    ...
                    <div class="legend-item green">
                        ...
                        <div class="legend-content">
                            ...
                            <p class="legend-desc green">Berat Badan Ideal</p>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Special Weight Alert -->
            <div class="alert-box">
                <div class="alert-content">
                    <span class="alert-icon">⚠</span>
                    <div>
                        <h5 class="alert-title">Perhatian Khusus: Malnutrisi</h5>
                        <p class="alert-text">
                            <strong>Kurus (Underweight)</strong> adalah kondisi dimana berat badan anak berada di bawah <strong>-2 SD</strong> dari standar WHO.
                        </p>
                        <p class="alert-text">
                            <strong>Gemuk (Overweight)</strong> adalah kondisi dimana berat badan anak berada di atas <strong>+2 SD</strong> dari standar WHO.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="reference-section">
                <p class="reference-text">
                    ...
                    <strong>Referensi:</strong> Standar WHO untuk Weight-for-Age (WFA) anak usia 0-60 bulan
                </p>
                <p class="reference-note">
                    SD = Standard Deviation (Standar Deviasi). Nilai ini digunakan untuk menentukan status gizi anak berdasarkan berat badan sesuai umur.
                </p>
            </div>
        </div>
    </div>
